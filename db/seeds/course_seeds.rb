class CourseSeeds
  ...
  COURSES = [
    ...
    {
      title: "Seminar: Digital Music Composition",
      course_codes: ["ART 507", "EMDA 399", "MUS 399"],
      credits_min: 2,
      credits_max: 2,
      interest: 100,
      enrollments: [
    ...
    {
      title: "Counterpoint",
      course_codes: ["MUS 542"],
      credits_min: 3,
      credits_max: 3,
      interest: 75,
      enrollments: [
        {
          instructor: "Christine Eggert",
          quarter_flexdate: "2016-Spring",
        }
      ]
    },
    ...
    {
      title: "Graduate Seminar: Art of Data",
      course_codes: ["ART 507", "EMDA 331"],
      credits_min: 4,
      credits_max: 4,
      interest: 75,
      enrollments: [
        {
          instructor: "Randolph Jones",
          quarter_flexdate: "2016-Fall",
        }
      ]
    },
    ...
    {
      title: "Composition Survey",
      course_codes: ["MUP 543"],
      credits_min: 2,
      credits_max: 2,
      interest: 90,
      enrollments: [
        {
          instructor: "Dr. Mark Jacobs",
          quarter_flexdate: "2016-Fall",
        }
      ]
    },
    ...
    {
      title: "Applications in Interdisciplinary Graduate Studies",
      course_codes: ["MIIS 521"],
      credits_min: 3,
      credits_max: 3,
      interest: 100,
      enrollments: [
        {
          instructor: "Kristin Nagy Catz",
          quarter_flexdate: "2017-Winter",
        }
      ]
    },

    {
      title: "Art and Technology Methods",
      course_codes: ["ART 507"],
      credits_min: 4,
      credits_max: 4,
      interest: 90,
      enrollments: [
    ...
    {
      title: "Research and Assessment in Interdisciplinary Graduate Studies",
      course_codes: ["MIIS 522"],
      credits_min: 3,
      credits_max: 3,
      interest: 100,
      enrollments: [
        {
          instructor: "Kristin Nagy Catz",
          quarter_flexdate: "2017-Spring",
        }
      ]
    },

    {
      title: "Cultures of Video Gaming: The Serious Business of Play",
      course_codes: ["COMM 560", "EMDA 410"],
      credits_min: 4,
      credits_max: 4,
      interest: 75,
      enrollments: [
        {
          instructor: "Precious Yamaguchi",
          quarter_flexdate: "2017-Spring",
        }
      ]
    },
    ...
    { credits_min: 4, credits_max: 4, interest: 80, course_codes: "COMM 424", title: "Creative Entrepreneurship" },
    ...
    { credits_min: 1, credits_max: 4, interest: 70, course_codes: ["EMDA 365", "ART 365"], title: "Sound Art and Experimental Music Methods" },
    { credits_min: 1, credits_max: 4, interest: 50, course_codes: "EMDA 399", title: "Special Studies" },
    { credits_min: 4, credits_max: 4, interest: 75, course_codes: ["EMDA 411", "COMM 411"], title: "Online Cultures" },
    ...
    { credits_min: 2, credits_max: 2, interest: 75, course_codes: "MUS 323", title: "Fundamentals of Conducting" },
    { credits_min: 2, credits_max: 2, interest: 75, course_codes: "MUS 324", title: "Intermediate Conducting" },
    { credits_min: 3, credits_max: 3, interest: 75, course_codes: "MUS 510", title: "Introduction to Graduate Studies in Music" },
    { credits_min: 3, credits_max: 3, interest: 80, course_codes: "MUS 540", title: "Form and Analysis" },
    { credits_min: 3, credits_max: 3, interest: 80, course_codes: "MUS 545", title: "Special Topic: Theory" },
    { credits_min: 3, credits_max: 3, interest: 75, course_codes: "MUS 546", title: "Theory in Performance" },
    { credits_min: 4, credits_max: 4, interest: 25, course_codes: "MUS 580", title: "Introduction to Music Education" },

    { credits_min: 4, credits_max: 4, interest: 75, course_codes: "TA 371", title: "Playwriting" },
    { credits_min: 3, credits_max: 3, interest: 75, course_codes: "TA 430", title: "The Art of Storytelling" },
    { credits_min: 4, credits_max: 4, interest: 90, course_codes: "TA 442", title: "Theatre Sound Design" },
  ]
