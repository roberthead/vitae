class CourseSeeds
  ...
  COURSES = [
    ...
    { credits_min: 4, credits_max: 4, interest: 75, course_codes: "COMM 312", title: "Screenwriting" },
    ...
    { credits_min: 4, credits_max: 4, interest: 75, course_codes: "COMM 472D", title: "Advanced Fictional Film Production" },

    { credits_min: 4, credits_max: 4, interest: 75, course_codes: "CW 320", title: "Emergent Forms" },
    { credits_min: 4, credits_max: 4, interest: 75, course_codes: "CW 386", title: "Songwriting" },

    { credits_min: 4, credits_max: 4, interest: 75, course_codes: "EMDA 320", title: "Writing Nonlinear" },
    { credits_min: 1, credits_max: 4, interest: 75, course_codes: ["EMDA 348", "ART 348"], title: "Concept Art and Preproduction Methods" },
    { credits_min: 1, credits_max: 4, interest: 75, course_codes: ["EMDA 349", "ART 349"], title: "Comic and Picture Book Methods" },
