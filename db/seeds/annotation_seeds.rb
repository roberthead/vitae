  ...
  ANNOTATIONS = [
    ...
    },
    {
      ...
      body_html: <<-EOS.squish
        ...
        <p>Her exercises are a treasure-trove of her personal strategies for releasing creativity or getting unstuck from a rut. These exercises provide a set of techniques that can contribute to a core of practices in the digitally mediated creative communities that I am exploring.</p>
      EOS
    },
    {
      citation: {
